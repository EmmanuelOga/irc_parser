...
describe IRCParser, "command responses" do
  ...
  it_generates IRCParser::Messages::WelcomeReply, "001 emmanuel :Welcome to the Internet Relay Network nick!user@host.com" do |message|
    message.nick = "emmanuel"
    message.welcome= "Welcome to the Internet Relay Network"
    message.user= "nick!user@host.com"
  end

  it_generates IRCParser::Messages::YourHostReply, "002 emmanuel :Your host is server.name running version 1.2.0"  do |message|
    message.nick = "emmanuel"
    message.server_name= "server.name"
    message.version= "1.2.0"
  end

  it_generates IRCParser::Messages::CreatedReply, "003 emmanuel :This server was created 10/10/2010 15:28:10" do |message|
    message.nick = "emmanuel"
    message.date= "10/10/2010 15:28:10"
  end

  it_generates IRCParser::Messages::MyInfoReply, "004 emmanuel server.name 1.2.3 AbC xYz"  do |message|
    message.nick = "emmanuel"
    message.server_name= "server.name"
  ...
  it_generates IRCParser::Messages::BounceReply, "005 emmanuel :Try server server.name port 10000"  do |message|
    message.nick = "emmanuel"
    message.server_name= "server.name"
    message.port= "10000"
  end
