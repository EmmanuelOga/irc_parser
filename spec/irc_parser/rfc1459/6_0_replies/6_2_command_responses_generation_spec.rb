...
describe IRCParser, "command responses" do
  ...
  it_parses "300 Emmanuel" do |message|
  ...
  it_parses "302 Emmanuel :user = +host" do |message|
  ...
  it_parses "303 Emmanuel :tony motola" do |message|
    message.nick.should == "Emmanuel"
  ...
  it_parses "301 Emmanuel nick :away message" do |message|
    message.nick.should ==  "Emmanuel"
    message.away_nick.should == "nick"
    message.message.should ==  "away message"
  end

  it_parses "305 Emmanuel :You are no longer marked as being away" do |message|
    message.nick = "Emmanuel"
  end

  it_parses "306 Emmanuel :You have been marked as being away" do |message|
    message.nick = "Emmanuel"
  end
  ...
  it_parses "323 Emmanuel :End of /LIST" do |message|
    message.nick.should == "Emmanuel"
  end

  it_parses "324 Emmanuel #channel o params" do |message|
    message.nick.should == "Emmanuel"
    message.channel.should ==  "#channel"
  ...
  it_parses "331 Emmanuel #channel :No topic is set" do |message|
    message.nick.should == "Emmanuel"
    message.channel.should ==  "#channel"
  end
  ...
  it_parses "341 Emmanuel #channel nick" do |message|
    message.nick.should == "Emmanuel"
    message.channel.should ==  "#channel"
  ...
  # summoning that user.
  it_parses "342 Emmanuel user :Summoning user to IRC" do |message|
    message.nick = "Emmanuel"
    message.user.should ==  "user"
  end
  ...
  it_parses "351 Emmanuel version.debuglevel server :the comments" do |message|
    message.nick.should == "Emmanuel"
  ...
  it_parses "315 Emmanuel name :End of /WHO list" do |message|
    message.nick.should == "Emmanuel"
  ...
  it_parses "364 Emmanuel mask server.com :10 server info" do |message|
    message.nick.should == "Emmanuel"
  ...
  it_parses "365 Emmanuel mask :End of /LINKS list" do |message|
    message.nick = "Emmanuel"
    message.mask.should ==  "mask"
  end
  ...
  it_parses "367 Emmanuel @channel banid" do |message|
    message.channel.should ==  "@channel"
    message.ban_id.should ==  "banid"
  end

  it_parses "368 Emmanuel &channel :End of channel ban list" do |message|
    message.channel.should ==  "&channel"
  end
  ...
  # the replies.
  it_parses "371 Emmanuel :Some Message" do |message|
    message.info.should ==  "Some Message"
  end

  it_parses "374 Emmanuel :End of /INFO list" do |message|
  end
  ...
  it_parses "391 Emmanuel server.com :10:10pm" do |message|
    message.server.should ==  "server.com"
  ...
  it_parses "392 Emmanuel :UserID   Terminal  Host" do |message|
  end

  it_parses "393 Emmanuel :012344567 012345678 01234567" do |message|
    message.users.should ==  "012344567 012345678 01234567"
  end

  it_parses "394 Emmanuel :End of users" do |message|
  end

  it_parses "395 Emmanuel :Nobody logged in" do |message|
  end
  ...
  # displayed anyway.
  it_parses "200 Emmanuel Link 1.10 destination.com next_server.net" do |message|
    message.version.should ==  "1.10"
    message.destination.should ==  "destination.com"
    message.next_server.should ==  "next_server.net"
  end

  it_parses "201 Emmanuel Try. class server" do |message|
    message.klass.should ==  "class"
    message.server.should ==  "server"
  end

  it_parses "202 Emmanuel H.S. class server" do |message|
    message.klass.should ==  "class"
    message.server.should ==  "server"
  end

  it_parses "203 Emmanuel ???? class 10.2.10.20" do |message|
    message.klass.should ==  "class"
    message.ip_address.should ==  "10.2.10.20"
  end

  it_parses "204 Emmanuel Oper class nick" do |message|
    message.nick.should ==  "Emmanuel"
    message.klass.should ==  "class"
    message.user_nick.should ==  "nick"
  end

  it_parses "205 Emmanuel User class nick" do |message|
    message.nick.should == "Emmanuel"
    message.klass.should ==  "class"
    message.user_nick.should ==  "nick"
  end

  it_parses "206 Emmanuel Serv class 10S 20C server nick!user@host" do |message|
    message.klass="class"
    message.intS="10S"
    message.intC="20C"
  ...
  it_parses "208 Emmanuel newtype 0 client_name" do |message|
    message.new_type.should ==  "newtype"
    message.client_name.should ==  "client_name"
  end

  it_parses "261 Emmanuel File logfile.log 2000" do |message|
  ...
  it_parses "211 Emmanuel linkname sendq 123 2048 456 1024 100" do |message|
    message.nick = "Emmanuel"
  ...
  it_parses "212 Emmanuel command 10" do |message|
    message.command.should ==  "command"
    message.count.should ==  "10"
  end

  it_parses "213 Emmanuel C host * name 1232 class" do |message|
    message.host.should ==  "host"
  ...
  it_parses "214 Emmanuel N host * name 1232 class" do |message|
    message.host.should ==  "host"
    message.name_param.should ==  "name"
    message.port.should ==  "1232"
    message.klass.should ==  "class"
  ...
  it_parses "215 Emmanuel I host1 * host2 1232 class" do |message|
  ...
  it_parses "216 Emmanuel K host * username 1232 class" do |message|
    message.host.should ==  "host"
  ...
  it_parses "218 Emmanuel Y class 10 20 30" do |message|
    message.klass.should ==  "class"
  ...
  it_parses "219 Emmanuel L :End of /STATS report" do |message|
    message.stats_letter= "L"
  end

  it_parses "241 Emmanuel L hostmask * servername.com 20" do |message|
    message.host_mask.should ==  "hostmask"
    message.server_name.should ==  "servername.com"
    message.max_depth.should == "20"
  end

  it_parses "242 Emmanuel :Server Up 20 days 10:30:30" do |message|
    message.days.should ==  "20"
    message.time.should ==  "10:30:30"
  end

  it_parses "243 Emmanuel O hostmask * name" do |message|
    message.host_mask.should ==  "hostmask"
    message.name_param.should ==  "name"
  end

  it_parses "244 Emmanuel H hostmask * servername" do |message|
    message.host_mask.should ==  "hostmask"
  ...
  it_parses "251 Emmanuel :There are 10 users and 20 invisible on 30 servers" do |message|
    message.users_count.should == "10"
    message.invisible_count.should == "20"
    message.servers.should == "30"
  end

  it_parses "252 Emmanuel 10 :operator(s) online" do |message|
    message.operator_count.should == "10"
  end

  it_parses "253 Emmanuel 7 :unknown connection(s)" do |message|
    message.connections.should == "7"
  end

  it_parses "254 Emmanuel 3 :channels formed" do |message|
    message.channels_count.should == "3"
  end

  it_parses "255 Emmanuel :I have 8 clients and 3 servers" do |message|
  ...
  it_parses "256 Emmanuel server.com :Administrative info" do |message|
    message.server.should ==  "server.com"
  end

  it_parses "257 Emmanuel :info" do |message|
    message.info.should ==  "info"
  end

  it_parses "258 Emmanuel :info" do |message|
    message.info.should ==  "info"
  end

  it_parses "259 Emmanuel :info" do |message|
    message.info.should ==  "info"
  end

  #------------------------------------------------------------------------------

  it_generates IRCParser::Messages::RplNone, "300 Emmanuel" do |message|
    message.nick = "Emmanuel"
  end

  it_generates IRCParser::Messages::RplUserHost, "302 Emmanuel :user = +host" do |message|
    message.nick = "Emmanuel"
    message.nicks = "user"
    message.host_with_sign = "+host"
  end
  ...
  it_generates IRCParser::Messages::RplIsOn, "303 Emmanuel :tony motola" do |message|
    message.nick = "Emmanuel"
    message.nicks = ["tony", "motola"]
  end

  it_generates IRCParser::Messages::RplAway, "301 Emmanuel nick :away message" do |message|
    message.nick = "Emmanuel"
    message.away_nick = "nick"
    message.message = "away message"
  end

  it_generates IRCParser::Messages::RplUnAway, "305 Emmanuel :You are no longer marked as being away" do |message|
    message.nick = "Emmanuel"
  end

  it_generates IRCParser::Messages::RplNowAway, "306 Emmanuel :You have been marked as being away" do |message|
    message.nick = "Emmanuel"
  end
  ...
  it_generates IRCParser::Messages::RplListStart, "321 Emmanuel Channel :Users  Name" do |message|
    message.nick = "Emmanuel"
  end
  ...
  it_generates IRCParser::Messages::RplListEnd, "323 Emmanuel :End of /LIST" do |message|
    message.nick = "Emmanuel"
  end
  ...
  it_generates IRCParser::Messages::RplInviting, "341 Emmanuel #channel nick" do |message|
    message.nick = "Emmanuel"
    message.channel = "#channel"
    message.nick_inv = "nick"
  end

  it_generates IRCParser::Messages::RplSummoning, "342 Emmanuel user :Summoning user to IRC" do |message|
    message.nick = "Emmanuel"
    message.user = "user"
  end

  it_generates IRCParser::Messages::RplVersion, "351 Emmanuel version.debuglevel server :the comments" do |message|
    message.nick = "Emmanuel"
  ...
  it_generates IRCParser::Messages::RplEndOfWho, "315 Emmanuel pattern :End of /WHO list" do |message|
    message.nick = "Emmanuel"
  ...
  it_generates IRCParser::Messages::RplLinks, "364 Emmanuel mask server.com :10 server info" do |message|
    message.nick = "Emmanuel"
    message.mask = "mask"
  ...
  it_generates IRCParser::Messages::RplEndOfLinks, "365 Emmanuel mask :End of /LINKS list" do |message|
    message.nick = "Emmanuel"
    message.mask = "mask"
  end

  it_generates IRCParser::Messages::RplBanList, "367 Emmanuel @channel banid" do |message|
    message.nick = "Emmanuel"
    message.channel = "@channel"
    message.ban_id = "banid"
  end

  it_generates IRCParser::Messages::RplEndOfBanList, "368 Emmanuel &channel :End of channel ban list" do |message|
    message.nick = "Emmanuel"
    message.channel = "&channel"
  end

  it_generates IRCParser::Messages::RplInfo, "371 Emmanuel :Some Message" do |message|
    message.nick = "Emmanuel"
    message.info = "Some Message"
  end

  it_generates IRCParser::Messages::RplEndOfInfo, "374 Emmanuel :End of /INFO list" do |message|
    message.nick = "Emmanuel"
  end

  it_generates IRCParser::Messages::RplMotdStart, "375 Emmanuel :- pepito.com Message of the day -" do |message|
    message.nick = "Emmanuel"
    message.server = "pepito.com"
  end

  it_generates IRCParser::Messages::RplMotd, "372 Emmanuel :- This is the very cool motd" do |message|
    message.nick = "Emmanuel"
    message.motd = "This is the very cool motd"
  end

  it_generates IRCParser::Messages::RplEndOfMotd, "376 Emmanuel :End of /MOTD command" do |message|
    message.nick = "Emmanuel"
  end

  it_generates IRCParser::Messages::RplYouReOper, "381 Emmanuel :You are now an IRC operator" do |message|
    message.nick = "Emmanuel"
  end

  it_generates IRCParser::Messages::RplRehashing, "382 Emmanuel config.sys :Rehashing" do |message|
    message.nick = "Emmanuel"
    message.config_file = "config.sys"
  end

  it_generates IRCParser::Messages::RplTime, "391 Emmanuel server.com :10:10pm" do |message|
    message.nick = "Emmanuel"
    message.server = "server.com"
    message.local_time = "10:10pm"
  end

  it_generates IRCParser::Messages::RplUsersStart, "392 Emmanuel :UserID   Terminal  Host" do |message|
    message.nick = "Emmanuel"
  end

  it_generates IRCParser::Messages::RplUsers, "393 Emmanuel :012344567 012345678 01234567" do |message|
    message.nick = "Emmanuel"
    message.users = "012344567 012345678 01234567"
  end

  it_generates IRCParser::Messages::RplEndOfUsers, "394 Emmanuel :End of users" do |message|
    message.nick = "Emmanuel"
  end

  it_generates IRCParser::Messages::RplNoUsers, "395 Emmanuel :Nobody logged in" do |message|
    message.nick = "Emmanuel"
  end

  it_generates IRCParser::Messages::RplTraceLink, "200 Emmanuel Link 1.10 destination.com next_server.net" do |message|
    message.nick = "Emmanuel"
  ...
  it_generates IRCParser::Messages::RplTraceConnecting, "201 Emmanuel Try. class server" do |message|
    message.nick = "Emmanuel"
    message.klass = "class"
    message.server = "server"
  end

  it_generates IRCParser::Messages::RplTraceHandshake, "202 Emmanuel H.S. class server" do |message|
    message.nick = "Emmanuel"
    message.klass = "class"
    message.server = "server"
  end

  it_generates IRCParser::Messages::RplTraceUnknown, "203 Emmanuel ???? class 10.2.10.20" do |message|
    message.nick = "Emmanuel"
    message.klass = "class"
    message.ip_address = "10.2.10.20"
  end

  it_generates IRCParser::Messages::RplTraceOperator, "204 Emmanuel Oper class nick" do |message|
    message.nick = "Emmanuel"
    message.klass = "class"
    message.user_nick = "nick"
  end

  it_generates IRCParser::Messages::RplTraceUser, "205 Emmanuel User class nick" do |message|
    message.nick = "Emmanuel"
    message.klass = "class"
    message.user_nick = "nick"
  end

  it_generates IRCParser::Messages::RplTraceServer, "206 Emmanuel Serv class 10S 20C server nick!user@host" do |message|
    message.nick = "Emmanuel"
    message.klass    = "class"
    message.intS     = "10S"
    message.intC     = "20C"
  ...
  it_generates IRCParser::Messages::RplTraceNewType, "208 Emmanuel newtype 0 client_name" do |message|
    message.nick = "Emmanuel"
    message.new_type = "newtype"
    message.client_name = "client_name"
  end

  it_generates IRCParser::Messages::RplTraceLog, "261 Emmanuel File logfile.log 2000" do |message|
    message.nick = "Emmanuel"
    message.logfile = "logfile.log"
    message.debug_level = "2000"
  end

  it_generates IRCParser::Messages::RplStatsLinkInfo, "211 Emmanuel linkname sendq 123 2048 456 1024 100" do |message|
    message.nick = "Emmanuel"
    message.linkname= "linkname"
    message.sendq= "sendq"
    message.sent_messages= 123
  ...
  it_generates IRCParser::Messages::RplStatsCommands, "212 Emmanuel command 10" do |message|
    message.nick = "Emmanuel"
    message.command = "command"
    message.count = 10
  end

  it_generates IRCParser::Messages::RplStatsCLine, "213 Emmanuel C host * name 1232 class" do |message|
    message.nick = "Emmanuel"
    message.host = "host"
  ...
  it_generates IRCParser::Messages::RplStatsNLine, "214 Emmanuel N host * name 1232 class" do |message|
    message.nick = "Emmanuel"
    message.host = "host"
    message.name_param = "name"
    message.port = "1232"
  ...
  it_generates IRCParser::Messages::RplStatsILine, "215 Emmanuel I host1 * host2 1232 class" do |message|
    message.nick = "Emmanuel"
    message.host = "host1"
  ...
  it_generates IRCParser::Messages::RplStatsKLine, "216 Emmanuel K host * username 1232 class" do |message|
    message.nick = "Emmanuel"
    message.host = "host"
  ...
  it_generates IRCParser::Messages::RplStatsYLine, "218 Emmanuel Y class 10 20 30" do |message|
    message.nick = "Emmanuel"
    message.klass = "class"
  ...
  it_generates IRCParser::Messages::RplEndOfStats, "219 Emmanuel L :End of /STATS report" do |message|
    message.nick = "Emmanuel"
    message.stats_letter= "L"
  end

  it_generates IRCParser::Messages::RplStatsLLine, "241 Emmanuel L hostmask * servername.com 20" do |message|
    message.nick = "Emmanuel"
  ...
  it_generates IRCParser::Messages::RplStatsUptime, "242 Emmanuel :Server Up 20 days 10:30:30" do |message|
    message.nick = "Emmanuel"
    message.days = "20"
    message.time = "10:30:30"
  end

  it_generates IRCParser::Messages::RplStatsOLine, "243 Emmanuel O hostmask * name" do |message|
    message.nick = "Emmanuel"
    message.host_mask = "hostmask"
    message.name_param = "name"
  end

  it_generates IRCParser::Messages::RplStatsHLine, "244 Emmanuel H hostmask * servername" do |message|
    message.nick = "Emmanuel"
    message.host_mask = "hostmask"
  ...
  it_generates IRCParser::Messages::RplLUserClient, "251 Emmanuel :There are 10 users and 20 invisible on 30 servers" do |message|
    message.nick = "Emmanuel"
  ...
  it_generates IRCParser::Messages::RplLUserOp, "252 Emmanuel 10 :operator(s) online" do |message|
    message.nick = "Emmanuel"
    message.operator_count = 10
  end

  it_generates IRCParser::Messages::RplLUserUnknown, "253 Emmanuel 7 :unknown connection(s)" do |message|
    message.nick = "Emmanuel"
    message.connections = 7
  end

  it_generates IRCParser::Messages::RplLUserChannels, "254 Emmanuel 3 :channels formed" do |message|
    message.nick = "Emmanuel"
    message.channels_count = 3
  end

  it_generates IRCParser::Messages::RplLUserMe, "255 Emmanuel :I have 8 clients and 3 servers" do |message|
    message.nick = "Emmanuel"
    message.clients_count = 8
    message.servers_count = 3
  end

  it_generates IRCParser::Messages::RplAdminMe, "256 Emmanuel server.com :Administrative info" do |message|
    message.nick = "Emmanuel"
    message.server = "server.com"
  end

  it_generates IRCParser::Messages::RplAdminLoc1, "257 Emmanuel :info" do |message|
    message.nick = "Emmanuel"
    message.info = "info"
  end

  it_generates IRCParser::Messages::RplAdminLoc2, "258 Emmanuel :info" do |message|
    message.nick = "Emmanuel"
    message.info = "info"
  end

  it_generates IRCParser::Messages::RplAdminEmail, "259 Emmanuel :info" do |message|
    message.nick = "Emmanuel"
    message.info = "info"
  end
