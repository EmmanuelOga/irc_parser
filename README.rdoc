...
The parser is quite strict in parsing the input you provide acording with the RFC definition, so don't forget to include the IRC delimiters in the messages ('\r\n').
  ...
  # [nil, "Angel", "PRIVMSG", "Wiz", "Hello are you receiving this message ?"]
...
* The library was initially built looking at the rfc 1459. When I started using it, I realised most servers and clients where designed with rfc 2812 as reference. At this point irc_parser is mostly 1459
compliant, with some of the messages updated to the rfc 2812. Fixes/patches are warmly welcome!

== AUTHORS

A lot of projects where reviewed while implementing this library. My
hope is that we developers of IRC stuff can join forces to get one of
the most boring parts of IRC development done (parsing/generating
messages). I may or may not have stolen something from one of
these. If I forget about anyone please ping me so I can include you
here.
